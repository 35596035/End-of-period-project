...
|前置條件|需完成登入作業|
|後置條件|付費後成為會員|
|主要成功情節|1.客戶點擊首頁的升級跳轉到付費頁面<br>2.選擇要第三方電信公司或銀行進行付費<br>3.付費成功即成為會員<br>4.系統人員進入後台，確認會員資格後給于會員權限|
|例外情節|*3a.若付費失敗則不能成為會員|
|其他需求|無|
...
|前置條件|需引入會員資料|
|後置條件|無|
|主要成功情節|1.成功登入會員後可以收聽各地音樂<br>2.收聽音樂過程不會有廣告跳出<br>3.點選設定，在音質設定可以進行選擇<br>4.點選歌曲可以下載<br>5.沒有網路連接時可以繼續收聽音樂<br>6.點選個人帳戶，點選取消訂閱後續即不會自動續費|
|例外情節|無|
|其他需求|無|
