...
|案例名稱|登入作業|
|-------|-----------|
|使用案例描述|讓客戶、會員與系統人員可以進入網站使用平台功能
|主要參與者|客戶、會員及系統人員
...
|前置條件|該使用者還享有會員身分期間|
|後置條件|無|
|主要成功情節|1.會員登入後，進到享有會員權限的網頁平台<br>3.點選音樂專輯，於音樂專輯圖片下方的下載鍵，按下即可下載<br>4.點選右上方個人帳戶鍵，展開會員帳戶介面，點選取消方案後，系統會提示會員到期截止日，並按下繼續取消鍵即可完成退訂會員|
|例外情節|*4a.若要取消退訂會員功能按下回到帳戶鍵即可
